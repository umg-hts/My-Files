...
class RepayRequest(object):
    ...
    """
    openapi_types = {'currency_pair': 'str', 'currency': 'str', 'mode': 'str', 'amount': 'str'}

    attribute_map = {'currency_pair': 'currency_pair', 'currency': 'currency', 'mode': 'mode', 'amount': 'amount'}

    def __init__(
        self, currency_pair=None, currency=None, mode=None, amount=None, local_vars_configuration=None
    ):  # noqa: E501
