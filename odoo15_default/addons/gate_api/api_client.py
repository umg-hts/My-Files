...
import odoo.addons.gate_api.models
from odoo.addons.gate_api import rest
from odoo.addons.gate_api.exceptions import ApiValueError, ApiException, GateApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None, pool_threads=1):
        ...
        self.user_agent = 'OpenAPI-Generator/4.23.2/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(odoo.addons.gate_api.models, klass)
